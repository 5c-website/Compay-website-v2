        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              ...
              {/* <img width="60" height="60" src="https://img.icons8.com/ios-filled/50/9089fc/delete-sign--v1.png" alt="close" className="absolute top-0 right-0 p-4 cursor-pointer"/> */}
                <div className=' flex flex-col justify-center items-center m-8'>
                    ...
                    <button className=" Dialog-button" role="button" onClick={()=>navigate("/")}>Back to site</button>
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
