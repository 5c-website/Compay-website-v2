...
const ArticleContentPage = () => {
  ...
  const collection = COLLECTION_TYPES.ARTICLES; // Specifically for articles

  console.log("Article Content Page Debug:", {
        ...
        {article.category.articles
          ...
          .map((relatedArticle) => (
            <div
              ...
              onClick={() =>
                navigate(`/impact/blog-content/articles/${relatedArticle.slug}`)
              }
            >
