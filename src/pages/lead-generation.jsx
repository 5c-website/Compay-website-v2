...
import mobileMockUpImage from "../../public/img/lead-generation/mobile.png";
...
const TeleradiologyLanding = () => {
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            ...
            <span className="text-gray-800 font-medium text-sm md:text-base">
              Introducing AI - Powered Diagostics
            </span>
          </div>
        </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-3 mb-8 md:hidden">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            ...
            <span className="font-medium text-sm">2000+ Happy Clients</span>
          </div>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            <FileText className="w-4 h-4 text-blue-600" />
            <span className="font-medium text-sm">7000+ Reports a day</span>
          </div>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            <Download className="w-4 h-4 text-blue-600" />
            <span className="font-medium text-sm">10k+ App Downloads</span>
          </div>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            <Users className="w-4 h-4 text-blue-600" />
            <span className="font-medium text-sm">15k+ Active Users</span>
          </div>
        </div>

        {/* Desktop Layout with Stats */}
        <div className="hidden md:block relative">
          {/* Extra padding container to prevent overlap */}
          <div className="pt-16 px-16 pb-16">
            {/* Stats Positioning */}
            <div className="absolute left-0 top-0">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
                <Users className="w-5 h-5 text-blue-600" />
                <span className="font-medium">2000+ Happy Clients</span>
              </div>
            </div>

            <div className="absolute right-0 top-1/3 -translate-y-1/3">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
                <FileText className="w-5 h-5 text-blue-600" />
                <span className="font-medium">7000+ Reports a day</span>
              </div>
            </div>

            <div className="absolute right-0 top-2/3 -translate-y-2/3">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
                <Download className="w-5 h-5 text-blue-600" />
                <span className="font-medium">10k+ App Downloads</span>
              </div>
            </div>

            {/* Main Image */}
            <div className="w-4/5 aspect-[16/9] bg-white rounded-3xl shadow-2xl overflow-hidden ml-12">
              <img
            ...
            <div className="absolute left-0 bottom-0">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
                <Users className="w-5 h-5 text-blue-600" />
                <span className="font-medium">15k+ Active Users</span>
              </div>
            </div>
          </div>
        </div>
  ...
  const FlowChartSection = () => {
      ...
      <div className="absolute group" style={{ left: node.x, top: node.y }}>
        <div className="relative">
          ...
          <img
            src={node.image}
            alt={node.title}
            className="w-20 h-20 rounded-lg p-2 hover:shadow-lg transition-all duration-200"
          />
    ...
    return (
      <div className="p-4 md:p-12 my-12 md:my-6">
        <h2 className="text-2xl md:text-4xl font-bold mb-8 md:mb-6 text-center">
          5C Radiology Workflow
        </h2>

        {/* Desktop View */}
        <div className="hidden md:block relative w-full h-[450px] rounded-xl">
  ...
  const MobileAppSection = () => (
    <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12 my-24">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6">
          ...
          <div className="flex gap-4 mt-8">
            ...
            <button
              className="px-8 py-3 bg-gray-900 text-white rounded-3xl hover:bg-gray-800 transition-colors"
              onClick={() =>
                window.open(
            ...
            >
              <img src={playstore} alt="App Store" className="w-5 h-5" />
              Google Play
            </button>
          </div>
        </div>
  ...
  const ContactSection = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      // Perform operations with formData
