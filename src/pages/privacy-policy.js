...
5C-CyberSecurity Department by expressing their concerns through the <label className=' text-[#00d4ff] font-italic'>email
address <a href='mailto:cybersafe@5cnetwork.com'>cybersafe@5cnetwork.com</a></label>
                                        </p>
                                    </li>
                </ul>
...
damages or loss of profits.
                ...
                <li className=' w-full max-w-full items-start mb-8 pl-0 flex'>
                                        <div className='bullet-line-css'></div>
                                        <p className=' mt-0 mb-0 leading-8 text-xl  font-use-one' style={{color:'rgba(255, 255, 255, .85)'}}>
                                        Please   feel   free   to   contact   our   Privacy   Grievance   Officer   at &nbsp;
                                        <a href='mailto:privacy@5cnetwork.com' className=' text-[#00d4ff] font-italic'>privacy@5cnetwork.com </a>for
                                        </p>
                                    </li>
                                    <li className=' w-full max-w-full items-start mb-8 pl-0 flex'>
                                        <div className='bullet-line-css'></div>
