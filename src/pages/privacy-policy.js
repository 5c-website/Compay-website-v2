...
function Privacypolicy({data}) {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="The Company provides teleradiology and tele-diagnostics services and solutions (“Services”). As an individual (“Patient”), if you undergo a radiology test like an x-ray, MRI or CT at one of the Company’s radiology/diagnostic partners (“Diagnostic Partner”)," />
...
address<label className=' text-[#00d4ff] font-italic'> <a href='mailto:cybersafe@5cnetwork.com'>cybersafe@5cnetwork.com</a></label>
                                        </p>
                                    </li>
                </ul>
