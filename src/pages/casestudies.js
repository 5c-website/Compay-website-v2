                        ...
                        <div className='mt-20 block relative overflow-hidden'>
                            <div className=' relative block'>
                                <div>
                                    <div className='mb-0'>
                                        <div>
                                            {strapiContent?.map((blog,index) => (
                                                <div key={index} className='blogitems'>
                                                    <Link to={`/casestudy/${blog.slug}`} state={{ blogTitle: blog.title }} className='w-full max-w-full inline-block text-lg' style={{ lineHeight: '26px' }}>
                                                        <div className='w-full max-w-full pl-5 pr-5' style={{ marginBottom: '60px' }}>
                                                            ...
                                                            <div className='blog-content'>
                                                                ...
                                                                <h2
                                                                    className='uppercase mt-0 mb-0 text-[40px] sm:text-[28px] font-use'
                                                                    style={{ letterSpacing: 0, lineHeight: '120%', color: '#fff' }}
                                                                >
                                                                    {blog.title}
                                                                </h2>
