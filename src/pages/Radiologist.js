      ...
      <a href='https://play.google.com/store/apps/details?id=db.com.a5c' class="outer inline-block ml-6 mr-6 text-base align-top absolute uppercase cursor-pointer top-0 bottom-auto left-auto right-0 z-[99] mobile-screen-signin">
        ...
        Sign In
            ...
            <div className=' flex items-center flex-col sm:p-[1rem]'>
                    ...
                    <div className=' w-full max-w-full flex flex-col items-center pt-[100px] relative'>
                        ...
                        <div className=' h-auto max-w-full justify-between items-center flex relative ml-[100px] mb-[140px] w-[1100px] sm:flex-col sm:w-full sm:ml-0'>
                            <div className=' w-[541px] h-[580px] max-w-full items-center mr-0 flex relative px-[50px] py-[47px] sm:h-[284px] sm:mb-0 sm:p-5'>
                                ...
                                <img className=' w-[440px] h-[440px] object-cover bg-[rgba(0, 212, 255, 0)] relative max-w-full sm:w-full sm:h-full' style={{ filter: 'grayscale(1)' }} src={Content.center.localFile.url}></img>
                ...
                <button class="btn btn-2 hover-slide-up uppercase">
                  <a href='https://borderlessradiology.com/' target='_blank'><span>Reach Us</span></a>
                        ...
                        <div className='absolute top-auto bottom-0 left-0 right-auto sm:bottom-[-87px] '>
            ...
            <div className='footer section pl-0 pr-0'>
                        ...
                        <div className='flex flex-col items-start'>
                            ...
                            <div className='social-platform font-use sm:w-[100%]'>
                                ...
                                <Link to="https://twitter.com/5c_network" target='_blank' className=' mt-6 mr-6 max-w-full inline-block uppercase text-lg' style={{ color: '#fff', backgroundColor: 'rgba(255, 255, 255, 0)', lineHeight: '26px' }}>
                                    <img src={Content.socialPlatforms[1].localFile.url} alt='Twitter' className='mr-0 max-w-full inline-block align-middle'></img>
                                </Link>
                ...
                <a href='https://play.google.com/store/apps/details?id=db.com.a5c&pcampaignid=web_share' target='_blank' to="/Solutions" className='uppercase mb-4 text-sm leading-5 ' style={{ color: 'rgba(255, 255, 255, .85)', letterSpacing: '2px', backgroundColor: 'rgba(255, 255, 255, 0)' }}>ProtoCALL - for Radiographers</a>
