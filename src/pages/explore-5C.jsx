              ...
              <DialogHeader>
                ...
                <div className="bg-gray-50 px-3 sm:px-6 py-3 sm:py-4 rounded-xl w-full">
                  <p className="text-center text-gray-600 text-base sm:text-lg font-medium">
                    You're now part of a future where AI and radiology unite to
                    make diagnostics faster, smarter, and more precise.
                    <br />
      ...
      <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="w-full md:w-2/3">
          <p className="text-gray-700 text-sm md:text-base">
            Are you a radiologist seeking growth? Join 5C Network and be part of
            a dynamic team delivering fast, precise, and high-quality diagnostic
            reports.
          </p>
        </div>
