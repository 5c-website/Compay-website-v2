        ...
        <div className='max-w-full ml-auto mr-auto'>
          <div className='max-w-full relative w-[1200px] mt-[234px] sm:h-auto sm:mt-0 hero-section-solution'>
            ...
            <div className='relative flex w-full max-w-full justify-around  solutions-home-container'>
                <Link to="/radiologists" className=' font-medium uppercase text-lg  font-use text-[#fff] tracking-[2px] leading-[21px] bg-[#ffffff0] solution-items' style={{transition: 'all .25s ease-in' }}><span className='action-underline underline-closing'>{strapiContent.menuItems[0].items}</span></Link>
                <Link to="/clinicians" className=' font-medium uppercase text-lg  font-use text-[#fff] tracking-[2px] leading-[21px] bg-[#ffffff0] solution-items' style={{transition: 'all .25s ease-in' }}><span className='action-underline underline-closing'>{strapiContent.menuItems[1].items}</span></Link>
                <Link to="/hospitals" className=' font-medium uppercase text-lg  font-use text-[#fff] tracking-[2px] leading-[21px] bg-[#ffffff0] solution-items' style={{transition: 'all .25s ease-in' }}><span className='action-underline underline-closing'>{strapiContent.menuItems[2].items}</span></Link>
                <Link to="/diagnosticcenters" className=' font-medium uppercase text-lg  font-use text-[#fff] tracking-[2px] leading-[21px] bg-[#ffffff0] solution-items' style={{transition: 'all .25s ease-in' }}><span className='action-underline underline-closing'>{strapiContent.menuItems[3].items}</span></Link>
                <Link to="/healthcareaggregators" className=' font-medium uppercase text-lg  font-use text-[#fff] tracking-[2px] leading-[21px] bg-[#ffffff0] solution-items' style={{transition: 'all .25s ease-in' }}><span className='action-underline underline-closing'>{strapiContent.menuItems[4].items}</span></Link>
            </div>
          </div>
        </div>
      </div>
