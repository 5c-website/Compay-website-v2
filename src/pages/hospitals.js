...
function Radiologist({ data }) {
  const Content = data.allStrapiHospital.nodes[0];
            ...
            <div className=' w-full max-w-full flex flex-col items-center pt-[100px] relative'>
              ...
              <div className=' h-auto max-w-full justify-between items-center flex relative ml-[100px] mb-[140px] w-[1100px] sm:flex-col sm:w-full sm:ml-0'>
                <div className=' w-[541px] h-[580px] max-w-full items-center mr-0 flex relative px-[50px] py-[47px] sm:h-[284px] sm:mb-0 sm:p-5'>
                  <img alt='hospital'className=' z-[1] w-[200px] h-[200px] object-cover absolute top-0 bottom-auto left-0 right-auto sm:w-[95px] sm:h-[95px] sm:left-[8px]' src={Content.top.localFile.url}></img>
                  <img alt='hospital' className=' w-[440px] h-[440px] object-cover bg-[rgba(0, 212, 255, 0)] relative max-w-full sm:w-full sm:h-full' style={{ filter: 'grayscale(1)' }} src={Content.center.localFile.url}></img>
                  <img alt='hospital' className=' z-[1] w-[200px] h-[200px] object-cover absolute top-auto bottom-0 left-auto right-0 sm:w-[95px] sm:h-[95px] sm:right-[8px]' src={Content.bottom.localFile.url}></img>
                </div>
    ...
    <li key={index} className='w-full max-w-full items-start mb-8 pl-0 flex'>
      ...
      <p className='mt-0 mb-0 leading-8 text-xl text-[#fff] font-use-one'>
        {point.bodycontent.data.bodycontent}
                  ...
                  <div className=' flex flex-row-reverse w-full max-w-full sm:block  sm:justify-center'>
                      <Link to='/reachform'>
